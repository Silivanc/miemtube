    ...
    const metadata = `[
          {
            ...
            "fields": [
              ...
              {
                "id": "is_part_of",
                "value": "88b6afe1-c6b9-4f9e-b576-ded6ac03abf2"
              },
            ]
          }
        ]`;
        ...
        <div className="flex">
          ...
          <div className="upload-info">
            ...
            <div>
              ...
              />
              <label htmlFor="upload-video-checkbox">
                Удалить кадры без звука
              </label>
            </div>
            ...
            <select
              name="city"
              id="city-select"
              className="upload-info-element"
            >
              <option value="" defaultValue>
                -- Не выбирать плейлист --
              </option>
