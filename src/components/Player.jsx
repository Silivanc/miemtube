...
export default function Player() {
    ...
    const getVideoType = (url) => {
        const extension = url.split('.').pop(); // Получение расширения файла
        switch (extension) {
            case 'mp4':
                return 'video/mp4';
            case 'webm':
            ...
            case 'ogg':
                return 'video/ogg';
            default:
                return 'video/mp4'; // Тип по умолчанию
        }
    };
                ...
                <div className="player-main">
                    ...
                    <div className="player-main-info">
                        ...
                        <div className="player-main-info-date">
                            ...
                            <div className="player-main-info-date-number">
                                {video.videoInfo.start.split('T')[0]}
                            </div>
                        </div>
                    ...
                    <div className="player-main-course">
                        Название курса: {video.videoInfo.subjects}
                    </div>
                    ...
                    {playlistId === 'playlists' && videos && videos.length > 0 ? (
                        <>
                            <div className="player-recommend-next">
                                {videos[videoIndex + 1] ? (
                                    <>
                                        <div className="player-recommend-next-text">
